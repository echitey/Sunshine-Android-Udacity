 ...
 */
package br.com.echitey.android.sunshineapp.data;
...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String keyForLocation = context.getString(R.string.pref_location_use_key);
    ...
    public static boolean isMetric(Context context) {
        ...
        SharedPreferences prefs = PreferenceManager
                .getDefaultSharedPreferences(context);
        String keyForUnits = context.getString(R.string.pref_temp_key);
        String defaultUnits = context.getString(R.string.pref_temp_celsius_key);
        String preferredUnits = prefs.getString(keyForUnits, defaultUnits);
        String metric = context.getString(R.string.pref_temp_celsius_key);
